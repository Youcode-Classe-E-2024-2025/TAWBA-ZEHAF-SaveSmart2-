...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md mx-auto bg-white p-8 rounded-xl shadow-lg animate-fade-in">
        <div class="mb-8 text-center">
            <h2 class="text-3xl font-bold text-gray-800 mb-2">Inscription</h2>
            <p class="text-gray-500">Créez votre compte pour commencer</p>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-gray-200">
            <p class="text-center text-gray-600">
                Déjà un compte? 
                <a href="{{ route('login') }}" class="font-medium text-primary-600 hover:text-primary-500">Se connecter</a>
            </p>
        </div>
